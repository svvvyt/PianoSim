...
An interactive piano simulator built with React and TypeScript. This app allows users to play piano notes visually, switch between octaves, and hear the corresponding sounds in real time. The app uses .mp3 files for authentic piano sound playback and offers an intuitive interface to simulate the experience of playing a piano.
...
- Click on the piano keys or use the mouse to play the notes.
